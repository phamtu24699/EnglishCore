...
import com.english.repository.VocabularyRepository;
...
@Service
@Transactional
public class VocabularyServiceIpml implements WordService {
    @Autowired
    private VocabularyRepository wordEnityRepository;
